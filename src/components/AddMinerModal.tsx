    ...
    >
      ...
      <DialogContent>
        ...
        >
          ...
          >
            Soon, you&#39;ll be able to explore the latest miners and purchase
            them directly from your dashboard. Place orders to start mining
            within minutes, or secure preorders for upcoming models. Easily
            track your delivery, activation, and all other essential details
            about your new miners—right from your dashboard.
          </Typography>
        </Box>
      </DialogContent>
