...
export default function HardwarePurchaseDetailPage() {
      ...
      <Container maxWidth="md">
        <Box sx={{ py: 4 }}>
          ...
          <Button
            ...
            onClick={() => router.push("/accounting/hardware-purchases")}
            sx={{ mt: 2 }}
          >
            Back to Hardware Purchases
          </Button>
        </Box>
      </Container>
    );
  ...
  const unitTotal = invoice.quantity * invoice.unitPrice;
