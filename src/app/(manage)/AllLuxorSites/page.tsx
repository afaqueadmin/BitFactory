/**
 * src/app/(manage)/AllLuxorSites/page.tsx
 * All Luxor Workspace Sites Management Page (V2 API)
 *
 * Admin page for managing all Luxor workspace sites with full CRUD operations:
 * - Create new sites
...
export default function AllLuxorSitesPage() {
        ...
        >
          <Box>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
              Manage all Luxor mining workspace sites and subaccounts
            </Typography>
          </Box>
